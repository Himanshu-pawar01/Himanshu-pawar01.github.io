...
const PROFILE = {
  name: 'Himanshu Pawar',
  email: 'himanshupawar008@gmail.com',
  phone: '+91 8273707358',
  links: {
    github: '',
    linkedin: '#',
...
document.getElementById('Your_Name').textContent = PROFILE.name;
...
document.getElementById('https://github.com/Himanshu-pawar01').href = PROFILE.links.github;
